...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h6 class="h6 mt-4 text-uppercase">OVERVIEW of  </h6>

    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">

            <a class="btn btn-sm mr-2 " style="font-size: 12px;color:;white" href="client_manage_account_details.php?<?= $links; ?>"><i class="mdi mdi-buffer mr-2"></i> Overview</a>

            <a class="btn btn-sm mr-2 " style="font-size: 12px;" href="guest_list.php?<?= $links; ?>"><i class="mdi mdi-account-network mr-2"></i> Master List Guest</a>

            <a class="btn btn-sm mr-2 " style="font-size: 12px;" href="budget.php?<?= $links; ?>"><i class="mdi mdi-currency-usd mr-2"></i> Budget</a>

            <a class="btn btn-sm mr-2 " style="font-size: 12px;" href="task_calendar.php?<?= $links; ?>"><i class="mdi mdi-calendar-text mr-2"></i> Task Calendar</a>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12 mb-3">
        <ul class="list-group">
            <li class="list-group-item active">Package Include:</li>
                ...
                <li class="list-group-item"><i class="mdi mdi-checkbox-marked mr-2" style="font-size: 16px;"></i></li>
