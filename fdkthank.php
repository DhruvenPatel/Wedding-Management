...
<!--div class="container"-->
    <!--div class="row"-->
        <!--div class="col-md-12 mt-5"-->
                <svg>
                    <text x="50%" y="60%" text-anchor="middle"> THANKYOU FOR YOUR FEEDBACK . </text>
                </svg>
                ...
                <div class="text-light text-center">
                    <!-- <span>
                        <p>
                            ...
                            WE UPDATE YOUR BOOKING ...
                            </h4>
                        </p><br>
                        <H4>
                    </span> -->
                    <a href="index.php"><button class="btn btn-md ibtn">
                    <span style="margin-left: 10px;">
                        GO TO HOME
                    </span>
                </button></center></a>
                <hr>
                <!-- <a href="php-invoice/bill.php"><button class="btn btn-md ibtn">
                    <span style="margin-left: 10px;">
                        GENERATE BILL
                    </span>
                </button></center></a>
