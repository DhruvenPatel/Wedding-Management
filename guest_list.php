...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            <a class="btn btn-sm btn-secondary mr-2 " style="font-size: 12px;" href="client_manage_account_details.php?<?= $links; ?>"><i class="mdi mdi-buffer mr-2"></i> Overview</a>
            <a class="btn btn-sm btn-secondary mr-2 " style="font-size: 12px;" href="guest_list.php?<?= $links; ?>"><i class="mdi mdi-account-plus mr-2"></i> Master List Guest</a>
            <a class="btn btn-sm btn-secondary mr-2 " style="font-size: 12px;" href="budget.php?<?= $links; ?>"><i class="mdi mdi-currency-usd mr-2"></i> Budget</a>
            <a class="btn btn-sm btn-secondary mr-2 " style="font-size: 12px;" href="task_calendar.php?<?= $links; ?>"><i class="mdi mdi-calendar-text mr-2"></i> Task Calendar</a>
        </div>
    </div>
</div>
<?php
...
<div class="text-right mr-2 mb-3">
    <a class="btn btn-sm btn-secondary  mr-2" href="guest_add.php?<?= $links; ?>"><i class="mdi mdi-account-plus mr-2"></i> Add New Guest</a>
</div>
    ...
    <?php foreach ($guest_list as $guest_list_rows) : ?>
        <tr>
            ...
            <td class="special">
                ...
                <a href="guest_delete.php?id=<?= $guest_list_rows->id; ?>&<?= $links; ?>" class="btn btn-secondary btn-sm" data-toggle="tooltip" data-placement="top" title="Delete This Guest"><i class="mdi mdi-account-remove"></i></a>
