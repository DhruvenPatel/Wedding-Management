...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            <a class="btn btn-secondary mr-2 text-uppercase" style="font-size: 12px;font-weight: bold;background-color:green;" href="photos_add.php"><i class="mdi mdi-upload mr-2"></i> Upload Image</a>
        </div>
    </div>
</div>
<?php
