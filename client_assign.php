            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4">
                ...
                <form method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="email" class="form-control" id="inputEmail" value="" placeholder="Enter email">
                    </div>
                    ...
                    <div class="form-row form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="wedding_date" value="" data-provide="datepicker" id="wedding_date" placeholder="Wedding Date">
                        </div>
<!-- 
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="bride" class="form-control" value="" id="brideName" placeholder="Enter Bride's Name">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="groom" class="form-control" value="" id="GroomsName" placeholder="Enter Groom's Name">
